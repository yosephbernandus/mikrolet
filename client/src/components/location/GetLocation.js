...
var myIcon = L.icon({
  ...
  iconAnchor: [22, 94],  // posisi Popup kiri dan kanan
  popupAnchor: [-9, -90] // posisi Popup atas dan bawah
});
    ...
    return (
      <div className="map">
        <Map className="map" worldCopyJump={true} center={position} zoom={this.state.zoom}>
          <TileLayer
            attribution="&amp;copy <a href=&quot;http://osm.org/copyright&quot;>OpenStreetMap</a> contributors and location by Alva Mende from the Mikro Project"
        ...
        <Card body className="message-form">
          <CardTitle>Welcome To Intelligent Information System General Transportation In Manado City. Thanks for stopping by!</CardTitle>
